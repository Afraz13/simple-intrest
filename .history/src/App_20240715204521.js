...
function App() {
  return (
    ...
    <form action="" className='mt-5'>
     ...
     <div className='mb-3'>
     <TextField className='w-100' id="outlined-basic" label="rate of intres" variant="outlined" />
     </div>
     <div className='mb-3'>
     <TextField className='w-100' id="outlined-basic" label="Outlined" variant="outlined" />
     </div>
    </form>
    </div>
    </div>
