...
function App() {
  ...
  return (
    ...
    <form  onSubmit={handlecalculate} action="" className='mt-5'>
     ...
     <Button variant="outlined" style={{width:'200px !important',height:'50px',position:'absolute !important',top:'50% !important',left:'50% !important',transform:'tran'}}>Reset</Button>
</Stack>
    </form>
    </div>
    </div>
