...
function App() {
  ...
  return (
    ...
    <form action="" className='mt-5'>
     <div className='mb-3'>
     <TextField value={principle || ""} name='' onChange={(e)=>getValidate(e)}  className='w-100' id="outlined-basic" label="Princle Amount" variant="outlined" />
     </div>
     <div className='mb-3'>
     <TextField value={rate || ""} className='w-100' id="outlined-basic" label="Rate of intrest" variant="outlined" />
     </div>
     <div className='mb-3'>
     <TextField value={year || ""} className='w-100' id="outlined-basic" label="Year" variant="outlined" />
     </div>
