...
function App() {
  ...
  return (
    ...
    <form  onSubmit={handlecalculate} action="" className='mt-5'>
     <div className='mb-3'>
     ...
     <div className='mb-3'>
     <TextField value={rate || ""} name='rate' onChange={(e)=>getValidate(e)}  className='w-100' id="outlined-basic" label="Rate of intrest" variant="outlined" />
     </div>
     { !israte &&
      <div>
      <p className='text-danger fw-bold'>*Invalid Input</p>
     ...
     <Button variant="outlined" style={{width:'200px !important',height:'50px',position:'absolute !important',top:'50% !important',left:'50% !important',transform:'translate(-50%,-50%)!important'}}>Reset</Button>
</Stack>
    </form>
    </div>
    </div>
